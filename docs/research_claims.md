...
`26922a77cbff8c08f9dd93c6a117fabe09deec33c8333079d987259a6a93fb1c` and
contains 17 rows: 14 exact non-fixture composed-board rows and 3 rejected
...
reports `composition_spec_source`, separating 11 curated exact rows from 3
...
isolates the three profiled generated exact rows in test and keeps curated exact
...
rows, while the fixture component-sum sanity checker abstains on all three generated
rows. All three generated test labels are unseen relative to train, so this is an
